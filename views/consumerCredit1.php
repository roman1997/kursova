<div class="col-xs-12 col-sm-8 col-md-9">
    ...
    <div id="menu1" class="tab-pane fade in active" ng-controller="consumerCredit1">
        <div class="row">
            <div class="col-sm-6">
                <h3>Векселі</h3>
                <div id="calc2">
                    ...
                    <div class="form-group">
                        <label for="t">Термін кредиту </label>
                        <input type="number" id="t" class="form-control" ng-model="t">
                    </div>
                    <div class="form-group">
            ...
            <div class="col-sm-6">
                <h3>Сума боргу</h3>
                <p>{{S() | number:0}} грн</p>
                <h3>Сума щомісячного платежу</h3>
                <p>{{q() | number :0}} грн</p>
